...
var Jhxlsx = {
    ...
    getBlob: function (workbookObj, options) {
        ...
        var blobData = new Blob([this.s2ab(wbout)], {type: "application/zip"});
        return blobData;
    },
    export: function (workbookObj, options) {
        ...
        folder.file("Gold Rates.xlsx", this.getBlob(workbookObj.rate2, options.option2));
        folder.file("Platinum Rates.xlsx", this.getBlob(workbookObj.rate3, options.option3));
